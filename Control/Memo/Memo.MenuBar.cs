...
namespace StickyMemos
{
    partial class Memo
    {
    	private void MenubarComponent()
    	{
    		...
    		this.BoldButton.Click += new EventHandler(this.Blod_Click);
    		this.ItalicButton.Click += new EventHandler(this.Italic_Click);
    		this.Underline.Click += new EventHandler(this.UnderlineButton_Click);
    		this.StrikeoutButton.Click += new EventHandler(this.StrikeoutButton_Click);
    	}
    	...
    	private void FontModeChange(IFontMode mode, Fonf font)
    	{
