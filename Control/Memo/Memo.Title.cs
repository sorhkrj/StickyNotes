...
namespace StickyMemos
{
    partial class Memo
    {
    	private void TitleComponent()
    	{
    		...
    		this.SaveItem = new ToolStripMemuItem("저장");
    		...
    		this.PurpleModeItem = new ToolStripMemuItem();
    	...
    	private ToolStripMemuItem SaveItem;
    	private ToolStripMenuItem RemoveItem;
    	
    	private ToolStripMemuItem YellowModeItem;
    	private ToolStripMenuItem GreenModeItem;
    	private ToolStripMenuItem PinkModeItem;
    	private ToolStripMemuItem PurpleModeItem;
    	...
    	private void Title_Up(object sender, MouseEventArgs e)
    	{
    		if (e.Button == MouseButtons.Left)
    		{
    			if (CanMove == true)
    	...
    	private void BlackForeColor()
    	{
    		...
    		this.Remove.ForeColor = Color.Black;
    	...
    	private void BlackForeColor()
    	{
    		...
    		this.Remove.ForeColor = Color.White;
